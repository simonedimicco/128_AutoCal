...
import time
from Spazzatura.WhiteDict import pulse_dict, time_differences, fine_tuning, retard_box
...
def process_measurement(measurement, photons, name=None):
    trigger_channel=17
    ...
    np.savez(f"{name}.npz", t_tot=t_tot, c_tot=c_tot)
