...
plt.xlim(0.75,10.25)
plt.scatter(x_18, frob_18_res, marker='o', label='target', c='navy')
plt.scatter(x_18, start_18_res, marker='x', label='start', c='navy')
...
plt.scatter(x_17, frob_17_res, marker='o', label='target', c='navy')
plt.scatter(x_17, start_17_res, marker='x', label='start', c='navy')
plt.xlim(5.75,10.25)
